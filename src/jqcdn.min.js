...
(function(window) {
    ...
    class QueryWrapper {
        ...
        width() { return this.elements[0]?.getBoundingClientRect().width ?? 0; }
        height() { return this.elements[0]?.getBoundingClientRect().height ?? 0; }

        fadeIn(duration = 400) {
            this.each(function() {
                this.style.opacity = 0;
                this.style.display = 'block'; // Or 'inline', etc., depending on original display
